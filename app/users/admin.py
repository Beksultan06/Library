...
class CustomUserAdmin(UserAdmin):
    # Список полей, отображаемых в списке пользователей в админке
    ...
    # Поля, которые будут отображаться на странице профиля пользователя в админке
    fieldsets = (
        (None, {'fields': ('email', 'password')}),
        (_('Personal info'), {'fields': ('full_name', 'gender', 'birth_date', 'category', 'phone')}),
